...
total_order_per_category = daily_sales.groupby('Product Category')['Total Order'].sum().reset_index()
...
output_filename = fr'C:\Users\Zemo\Documents\Python Tutorial\5th Week For Tutorial\Sales_per_Category_{date_today}.csv'
